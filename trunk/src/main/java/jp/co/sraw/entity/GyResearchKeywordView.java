...
/**
 * The persistent class for the gy_research_keyword_view database table.
 * 
 */
@Entity
@Table(name="gy_research_keyword_view")
@NamedQuery(name="GyResearchKeywordView.findAll", query="SELECT g FROM GyResearchKeywordView g")
public class GyResearchKeywordView implements Serializable {
