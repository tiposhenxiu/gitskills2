...
/**
 * The persistent class for the ev_event_public_tbl database table.
 *
 */
@Entity
@Table(name="ev_event_public_tbl")
@NamedQuery(name="EvEventPublicTbl.findAll", query="SELECT e FROM EvEventPublicTbl e")
public class EvEventPublicTbl implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private EvEventPublicTblPK id;
	...
	public EvEventPublicTbl() {
	}

	public EvEventPublicTblPK getId() {
		return this.id;
	}

	public void setId(EvEventPublicTblPK id) {
		this.id = id;
	}
