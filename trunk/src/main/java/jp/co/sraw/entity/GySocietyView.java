...
/**
 * The persistent class for the gy_society_view database table.
 * 
 */
@Entity
@Table(name="gy_society_view")
@NamedQuery(name="GySocietyView.findAll", query="SELECT g FROM GySocietyView g")
public class GySocietyView implements Serializable {
