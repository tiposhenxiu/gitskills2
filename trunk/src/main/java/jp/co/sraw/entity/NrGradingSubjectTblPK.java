...
/**
 * The primary key class for the nr_grading_subject_tbl database table.
 * 
 */
@Embeddable
public class NrGradingSubjectTblPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof NrGradingSubjectTblPK)) {
			return false;
		}
		NrGradingSubjectTblPK castOther = (NrGradingSubjectTblPK)other;
		return 
